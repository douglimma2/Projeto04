...
public class ValidarFormulario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(!request.getParameter("prova1").equals("")){
            ...
            if(valido){
                ...
                request.getRequestDispatcher("Tabela_EL_JSTL.jsp").forward(request, response);//Mudar para a tabela
            }else{
    ...
    private void PreencherServletContext(String nome,Double p1,Double tr,Double pj,Double fr,Double pf,ServletContext sc){
        ...
        {
            ArrayList<AlunoPSW> tabelaAlunos = new <AlunoPSW>ArrayList();
            tabelaAlunos.add(A);
            sc.setAttribute("ListaAlunos", tabelaAlunos);
        }else{
            ArrayList<AlunoPSW> tabelaAlunos = (ArrayList<AlunoPSW>) sc.getAttribute("ListaAlunos");
            tabelaAlunos.add(A);
            sc.setAttribute("ListaAlunos", tabelaAlunos);
        }
    }
